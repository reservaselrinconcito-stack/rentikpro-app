...
const StackedBarChart = ({ data, apartments }: { data: any[], apartments: Apartment[] }) => {
      ...
      <div className="flex flex-wrap gap-3 justify-center">
        {apartments.filter(apt => data.some(d => (d[apt.id] || 0) > 0)).map(apt => (
          <div key={apt.id} className="flex items-center gap-2">
            <div className="w-3 h-3 rounded-full" style={{ backgroundColor: apt.color || '#ccc' }}></div>
            <span className="text-xs font-bold text-slate-600">{apt.name}</span>
          </div>
        ))}
      </div>
        ...
        {data.map((d, i) => {
          ...
          return (
            <div key={i} className="flex-1 flex flex-col justify-end h-full group relative">
              ...
              <div
                className="w-full flex flex-col-reverse rounded-t-sm overflow-hidden min-h-[2px]"
                ...
                {apartments.map(apt => {
                  ...
                  return (
                    <div
                      ...
                      title={`${apt.name}: ${value.toLocaleString()}€`}
                    ></div>
                  );
                })}
              </div>
        ...
        <div className="space-y-6 animate-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="bg-white p-6 rounded-[2rem] border border-slate-200 shadow-sm">
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Promedio Mensual</p>
            ...
            <div className="bg-white p-6 rounded-[2rem] border border-slate-200 shadow-sm">
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">🏆 Mejor Mes</p>
            ...
            <div className="bg-white p-6 rounded-[2rem] border border-slate-200 shadow-sm">
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">📉 Peor Mes</p>
            ...
            <div className="bg-white p-6 rounded-[2rem] border border-slate-200 shadow-sm">
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Tasa de Ocupación</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 animate-in fade-in">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-white p-8 rounded-[3rem] border border-slate-200 shadow-sm">
              ...
              <StackedBarChart data={stackedChartData} apartments={apartments} />
            </div>
          </div>
        </div>
      )}

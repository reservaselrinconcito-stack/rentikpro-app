...
import { Search, MapPin, UserCheck, ChevronRight, Users, MessageCircle } from 'lucide-react';
...
export const Travelers: React.FC = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    const [tList, sList] = await Promise.all([store.getTravelers(), store.getStays()]);
    setTravelers(tList);
    setStays(sList);
  }, []);

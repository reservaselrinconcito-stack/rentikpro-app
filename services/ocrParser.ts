...
export const processImage = async (imageFile: File, onProgress: (p: number) => void): Promise<ScannedData> => {
  ...
  const result = await Tesseract.recognize(
    processedImage,
    'eng', // Usamos eng porque el MRZ está estandarizado en caracteres latinos básicos
    {
      logger: m => {

      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <h2 className="text-4xl md:text-5xl font-serif text-white mb-6 leading-tight">
            {t('rentik.invisible_tech')}<br className="hidden md:block" />
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          ...
          <div className="group bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 hover:bg-white/10 hover:border-orange-600/30 transition-all duration-300">
            ...
            <div className="mt-6 flex items-center gap-2">
              ...
              <span className="text-stone-400 text-xs">{t('common.booking_platforms')}</span>
            </div>
          </div>
          ...
          <div className="group bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 hover:bg-white/10 hover:border-orange-600/30 transition-all duration-300">
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="text-stone-500 text-[10px] font-black uppercase tracking-widest">{t('common.unified')}</span>
            </div>
            <h3 className="text-xl font-bold text-white mb-3">
            ...
            <div className="mt-6 flex items-center gap-2">
              <CheckCircle size={14} className="text-emerald-400" />
              <span className="text-stone-400 text-xs">{t('common.whatsapp_channels')}</span>
            </div>
          </div>
          ...
          <div className="group bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 hover:bg-white/10 hover:border-orange-600/30 transition-all duration-300">
            ...
            <div className="mt-6 flex items-center gap-2">
              <CheckCircle size={14} className="text-emerald-400" />
              <span className="text-stone-400 text-xs">{t('common.try_it')}</span>
            </div>
          </div>
        </div>

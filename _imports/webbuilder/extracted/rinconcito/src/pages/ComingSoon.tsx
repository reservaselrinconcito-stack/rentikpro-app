            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 py-20">
                ...
                <div className="max-w-4xl mb-24">
                    ...
                    <h1 className="font-serif text-6xl md:text-8xl text-white font-bold leading-[0.9] mb-8 tracking-tighter">
                        {project.name} <br /> <span className="text-stone-500 italic font-normal">{t('coming_soon_page.location_tag')}</span>
                    </h1>
                                    ...
                                    <div className="h-72 overflow-hidden relative bg-black">
                                        <img
                                            ...
                                            onError={(e) => {
                                                ...
                                                const next = imgFallback(loft.id);
                                                if (el.src.endsWith(next)) return;
                                                if (import.meta.env.DEV) console.warn('[img] failed:', loft.photos[0]);
                                                el.src = next;
                                            }}
                                        />
                                        ...
                                        <div className="absolute bottom-6 left-6">
                                            ...
                                            <span className="text-[10px] text-orange-400 font-black tracking-widest uppercase">{t('coming_soon_page.loft_type')}</span>
                                        </div>
                                    </div>
                                    <div className="p-10">

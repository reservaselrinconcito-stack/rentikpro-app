...
const ExperienceDetail: React.FC = () => {
  ...
  // Cast generic fields to their expected types if needed, or just use as is
  const highlights = (experience.highlights as string[]) || [];
  const practicalInfo = (experience.practicalInfo as string[]) || [];
  const sources = (experience.sources as string[]) || [];
    ...
    <div className="min-h-screen bg-stone-50 pb-20" style={{ fontSize: `${tokens.fontScale}rem` }}>
      ...
      <div className="relative h-[60vh] min-h-[400px] overflow-hidden">
        ...
        <div className="absolute top-24 left-6 md:left-20">
          <Link to="/experiencias" className="group flex items-center gap-2 text-white/80 hover:text-white transition-colors bg-white/10 backdrop-blur-md px-4 py-2 border border-white/20" style={{ borderRadius: tokens.radius }}>
        ...
        <div className="absolute bottom-12 left-6 md:left-20 right-6 max-w-4xl text-white">
          <div className="flex items-center gap-3 mb-6">
            <span className="text-white text-[10px] font-black uppercase px-3 py-1 shadow-lg" style={{ backgroundColor: tokens.accentColor, borderRadius: tokens.radius }}>
            ...
            <span className="text-white/60 text-[10px] font-black uppercase tracking-widest flex items-center gap-1">
              <MapPin size={10} className="text-emerald-400" /> {experience.town || siteConfig.locations[0].town}, {(experience.area as string) || siteConfig.locations[0].province}
            </span>
          </div>
      ...
      <div className="container mx-auto px-6 mt-12">
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            {/* Highlights */}
            {highlights.length > 0 && (
              <section className="bg-white p-8 md:p-12 border border-stone-100" style={{ borderRadius: tokens.radius, boxShadow: tokens.shadow }}>
                <h2 className="text-2xl font-serif text-stone-900 mb-8 flex items-center gap-3">
                  <span className="w-8 h-8 flex items-center justify-center text-sm" style={{ backgroundColor: `${tokens.accentColor}20`, color: tokens.accentColor, borderRadius: '50%' }}>01</span>
                  Lo más destacado
                </h2>
            ...
            {/* Practical Info */}
            <section className="p-8 md:p-12 text-white relative overflow-hidden" style={{ backgroundColor: tokens.primaryColor, borderRadius: tokens.radius, boxShadow: tokens.shadow }}>
              <div className="absolute top-0 right-0 w-32 h-32 bg-white/5 rounded-full -mr-16 -mt-16 blur-3xl"></div>
              <h2 className="text-2xl font-serif mb-8 flex items-center gap-3">
                <span className="w-8 h-8 bg-white/10 text-white flex items-center justify-center text-sm" style={{ borderRadius: '50%' }}>02</span>
              ...
              <div className="mt-12 pt-8 border-t border-white/10 flex flex-wrap gap-8 items-center text-[10px] uppercase tracking-widest font-black">
                <div className="flex items-center gap-2">
                  ...
                  Estacionalidad: <span className="text-white">{(experience.seasonality as string) || 'Todo el año'}</span>
                </div>
                {tags.map(tag => (
          ...
          <div className="lg:col-span-4 space-y-8">
            <div className="sticky top-28 space-y-8">
              ...
              <div
                className="bg-white p-8 border border-stone-100 text-center"
              ...
              >
                ...
                <Link
                  ...
                  className="block w-full text-white py-4 font-bold transition-all"
                  style={{ backgroundColor: tokens.primaryColor, borderRadius: `calc(${tokens.radius} / 2)`, boxShadow: tokens.shadow }}
                >
              ...
              <div className="bg-emerald-50 rounded-2xl p-6 border border-emerald-100 flex gap-4 items-start">
                ...
                <div>
                  <h4 className="font-bold text-stone-900 text-sm mb-1 line-tight">Contenido Verificado</h4>
                  <p className="text-[10px] text-stone-500 leading-relaxed uppercase tracking-wider font-medium">
                    Información extraída de fuentes oficiales y turismo regional actualizado por el equipo de {siteConfig.brand.name}.
                  </p>

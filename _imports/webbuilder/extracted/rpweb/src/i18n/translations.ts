...
const ca: typeof es = {
  ...es,
  nav: { ...es.nav, blog: 'Guies', comingSoon: 'Properament', book: 'Veure disponibilitat', availability: 'Disponibilitat' },
  price: { from: 'Des de', perNight: '/nit', ask: 'Consultar preu', note: '(Subjecte a canvis)' },
};

const fr: typeof es = {
  ...es,
  nav: { ...es.nav, home: 'Accueil', blog: 'Guides', contact: 'Contact', comingSoon: 'Prochainement', book: 'Voir disponibilité', availability: 'Disponibilité' },
  price: { from: 'À partir de', perNight: '/nuit', ask: 'Consulter prix', note: '(Sous réserve de modifications)' },
};

const de: typeof es = {
  ...es,
  nav: { ...es.nav, home: 'Startseite', apartments: 'Apartments', blog: 'Guides', contact: 'Kontakt', comingSoon: 'Demnächst', book: 'Verfügbarkeit prüfen', availability: 'Verfügbarkeit' },
  price: { from: 'Ab', perNight: '/Nacht', ask: 'Preis anfragen', note: '(Änderungen vorbehalten)' },
};

const eu: typeof es = {
  ...es,
  nav: { ...es.nav, home: 'Hasiera', apartments: 'Apartamentuak', blog: 'Gidariak', contact: 'Kontaktua', comingSoon: 'Laster', book: 'Eskuragarritasuna ikusi', availability: 'Eskuragarritasuna' },
  price: { from: 'Tik aurrera', perNight: '/gauko', ask: 'Prezioa kontsultatu', note: '(Aldaketak izan ditzake)' },
};

export const translations = { es, en, ca, fr, de, eu, nl: es };
export { es, en, ca, fr, de, eu };
